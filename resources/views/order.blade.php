...
@section('title', 'Оформелние заказа')
@section('content')
            ...
            <div class="row justify-content-center">
                ...
                <form action="{{route('basket-confirm')}}" method="POST">
                    <div>
                        ...
                        <br>
                        <input type="hidden" name="_token" value="cxB1lWEtIU8DBfnibpLcYyyQz29fIRZKaLhhbwi9">                    <input type="submit" class="btn btn-success" value="Подтвердите заказ">
                    </div>
                @csrf
                </form>
            </div>
